<template>
    <!-- TODO: backend pfps -->
    <div v-if="false" class="avatar my-auto flex-none" :class="large ? 'w-24 h-24' : 'w-10 h-10'">
        <div
    ...
    <div v-else class="avatar placeholder flex-none" :class="large ? 'w-24 h-24' : 'w-10 h-10'">
