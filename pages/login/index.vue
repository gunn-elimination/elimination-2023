<template>
    ...
    <div>
        ...
        <ol class="list-disc list-inside">
            ...
            <li>iOS Safari: Go to the Settings app, open "Safari" settings, and turn off the "Prevent Cross-Site Tracking". Make sure to turn this back on to protect your privacy!</li>
